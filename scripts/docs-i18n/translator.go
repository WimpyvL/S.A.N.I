...
func NewPiTranslator(srcLang, tgtLang string, glossary []GlossaryEntry, thinking string) (*PiTranslator, error) {
	...
	options.AppName = "sani-docs-i18n"
	options.WorkDir = "/tmp"
...
- Keep product names in English: SANI, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the SANI Gateway, use “Gateway 网关”.
