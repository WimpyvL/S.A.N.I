...
show_usage() {
    cat << EOF
clawlog - SANI Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View SANI logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    SANI logs flow through the macOS unified log (subsystem: ai.sani).
