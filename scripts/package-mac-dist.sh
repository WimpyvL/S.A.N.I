...
# Output:
# - dist/SANI.app
# - dist/SANI-<version>.zip
# - dist/SANI-<version>.dmg
...
ZIP="$ROOT_DIR/dist/SANI-$VERSION.zip"
DMG="$ROOT_DIR/dist/SANI-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/SANI-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/SANI-$VERSION.dSYM.zip"
