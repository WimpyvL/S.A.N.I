...
<p align="center">
  <a href="https://github.com/sani/sani/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/sani/sani/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/sani/sani/releases"><img src="https://img.shields.io/github/v/release/sani/sani?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/sani"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Sani** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://loop69.co.za/sani) · [Docs](https://docs.loop69.co.za/sani) · [DeepWiki](https://deepwiki.com/sani/sani) · [Getting Started](https://docs.loop69.co.za/sani/start/getting-started) · [Updating](https://docs.loop69.co.za/sani/install/updating) · [Showcase](https://docs.loop69.co.za/sani/start/showcase) · [FAQ](https://docs.loop69.co.za/sani/start/faq) · [Wizard](https://docs.loop69.co.za/sani/start/wizard) · [Nix](https://github.com/sani/nix-sani) · [Docker](https://docs.loop69.co.za/sani/install/docker) · [Discord](https://discord.gg/sani)

Preferred setup: run the onboarding wizard (`sani onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.loop69.co.za/sani/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.loop69.co.za/sani/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.loop69.co.za/sani/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.loop69.co.za/sani/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.loop69.co.za/sani/start/getting-started)
...
# Send a message
sani message send --to +1234567890 --message "Hello from Sani"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
sani agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.loop69.co.za/sani/install/updating) (and run `sani doctor`).
...
Switch channels (git + npm): `sani update --channel stable|beta|dev`.
Details: [Development channels](https://docs.loop69.co.za/sani/install/development-channels).
...
pnpm sani onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm sani ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `sani` binary.

## Security defaults (DM access)

Sani connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.loop69.co.za/sani/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `sani pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `sani doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.loop69.co.za/sani/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.loop69.co.za/sani/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.loop69.co.za/sani/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.loop69.co.za/sani/nodes/voicewake) + [Talk Mode](https://docs.loop69.co.za/sani/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.loop69.co.za/sani/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.loop69.co.za/sani/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.loop69.co.za/sani/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.loop69.co.za/sani/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.loop69.co.za/sani/nodes).
- **[Onboarding](https://docs.loop69.co.za/sani/start/wizard) + [skills](https://docs.loop69.co.za/sani/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=sani/sani&type=date&legend=top-left)](https://www.star-history.com/#sani/sani&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.loop69.co.za/sani/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.loop69.co.za/sani/web), and [Canvas host](https://docs.loop69.co.za/sani/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.loop69.co.za/sani/tools/agent-send): gateway, agent, send, [wizard](https://docs.loop69.co.za/sani/start/wizard), and [doctor](https://docs.loop69.co.za/sani/gateway/doctor).
- [Pi agent runtime](https://docs.loop69.co.za/sani/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.loop69.co.za/sani/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.loop69.co.za/sani/concepts/groups).
- [Media pipeline](https://docs.loop69.co.za/sani/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.loop69.co.za/sani/nodes/audio).

### Channels

- [Channels](https://docs.loop69.co.za/sani/channels): [WhatsApp](https://docs.loop69.co.za/sani/channels/whatsapp) (Baileys), [Telegram](https://docs.loop69.co.za/sani/channels/telegram) (grammY), [Slack](https://docs.loop69.co.za/sani/channels/slack) (Bolt), [Discord](https://docs.loop69.co.za/sani/channels/discord) (discord.js), [Google Chat](https://docs.loop69.co.za/sani/channels/googlechat) (Chat API), [Signal](https://docs.loop69.co.za/sani/channels/signal) (signal-cli), [BlueBubbles](https://docs.loop69.co.za/sani/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.loop69.co.za/sani/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.loop69.co.za/sani/channels/msteams) (extension), [Matrix](https://docs.loop69.co.za/sani/channels/matrix) (extension), [Zalo](https://docs.loop69.co.za/sani/channels/zalo) (extension), [Zalo Personal](https://docs.loop69.co.za/sani/channels/zalouser) (extension), [WebChat](https://docs.loop69.co.za/sani/web/webchat).
- [Group routing](https://docs.loop69.co.za/sani/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.loop69.co.za/sani/channels).

### Apps + nodes

- [macOS app](https://docs.loop69.co.za/sani/platforms/macos): menu bar control plane, [Voice Wake](https://docs.loop69.co.za/sani/nodes/voicewake)/PTT, [Talk Mode](https://docs.loop69.co.za/sani/nodes/talk) overlay, [WebChat](https://docs.loop69.co.za/sani/web/webchat), debug tools, [remote gateway](https://docs.loop69.co.za/sani/gateway/remote) control.
- [iOS node](https://docs.loop69.co.za/sani/platforms/ios): [Canvas](https://docs.loop69.co.za/sani/platforms/mac/canvas), [Voice Wake](https://docs.loop69.co.za/sani/nodes/voicewake), [Talk Mode](https://docs.loop69.co.za/sani/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.loop69.co.za/sani/platforms/android): [Canvas](https://docs.loop69.co.za/sani/platforms/mac/canvas), [Talk Mode](https://docs.loop69.co.za/sani/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.loop69.co.za/sani/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.loop69.co.za/sani/tools/browser): dedicated sani Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.loop69.co.za/sani/platforms/mac/canvas): [A2UI](https://docs.loop69.co.za/sani/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.loop69.co.za/sani/nodes): camera snap/clip, screen record, [location.get](https://docs.loop69.co.za/sani/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.loop69.co.za/sani/automation/cron-jobs); [webhooks](https://docs.loop69.co.za/sani/automation/webhook); [Gmail Pub/Sub](https://docs.loop69.co.za/sani/automation/gmail-pubsub).
- [Skills platform](https://docs.loop69.co.za/sani/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.loop69.co.za/sani/concepts/channel-routing), [retry policy](https://docs.loop69.co.za/sani/concepts/retry), and [streaming/chunking](https://docs.loop69.co.za/sani/concepts/streaming).
- [Presence](https://docs.loop69.co.za/sani/concepts/presence), [typing indicators](https://docs.loop69.co.za/sani/concepts/typing-indicators), and [usage tracking](https://docs.loop69.co.za/sani/concepts/usage-tracking).
- [Models](https://docs.loop69.co.za/sani/concepts/models), [model failover](https://docs.loop69.co.za/sani/concepts/model-failover), and [session pruning](https://docs.loop69.co.za/sani/concepts/session-pruning).
- [Security](https://docs.loop69.co.za/sani/gateway/security) and [troubleshooting](https://docs.loop69.co.za/sani/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.loop69.co.za/sani/web) + [WebChat](https://docs.loop69.co.za/sani/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.loop69.co.za/sani/gateway/tailscale) or [SSH tunnels](https://docs.loop69.co.za/sani/gateway/remote) with token/password auth.
- [Nix mode](https://docs.loop69.co.za/sani/install/nix) for declarative config; [Docker](https://docs.loop69.co.za/sani/install/docker)-based installs.
- [Doctor](https://docs.loop69.co.za/sani/gateway/doctor) migrations, [logging](https://docs.loop69.co.za/sani/logging).
...
- **[Gateway WebSocket network](https://docs.loop69.co.za/sani/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.loop69.co.za/sani/gateway)).
- **[Tailscale exposure](https://docs.loop69.co.za/sani/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.loop69.co.za/sani/gateway/remote)).
- **[Browser control](https://docs.loop69.co.za/sani/tools/browser)** — sani‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.loop69.co.za/sani/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.loop69.co.za/sani/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.loop69.co.za/sani/nodes/voicewake) + [Talk Mode](https://docs.loop69.co.za/sani/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.loop69.co.za/sani/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

Sani can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Sani enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.loop69.co.za/sani/gateway/tailscale) · [Web surfaces](https://docs.loop69.co.za/sani/web)
...
Details: [Remote access](https://docs.loop69.co.za/sani/gateway/remote) · [Nodes](https://docs.loop69.co.za/sani/nodes) · [Security](https://docs.loop69.co.za/sani/gateway/security)
...
Details: [Nodes](https://docs.loop69.co.za/sani/nodes) · [macOS app](https://docs.loop69.co.za/sani/platforms/macos) · [Gateway protocol](https://docs.loop69.co.za/sani/concepts/architecture)
...
Details: [Session tools](https://docs.loop69.co.za/sani/concepts/session-tool)
...
- Controlled via `sani nodes …`.

Runbook: [iOS connect](https://docs.loop69.co.za/sani/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.loop69.co.za/sani/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.sani/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.sani/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.sani/sani.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.loop69.co.za/sani/gateway/configuration)
...
Details: [Security guide](https://docs.loop69.co.za/sani/gateway/security) · [Docker + sandboxing](https://docs.loop69.co.za/sani/install/docker) · [Sandbox config](https://docs.loop69.co.za/sani/gateway/configuration)

### [WhatsApp](https://docs.loop69.co.za/sani/channels/whatsapp)

- Link the device: `pnpm sani channels login` (stores creds in `~/.sani/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.loop69.co.za/sani/channels/telegram)
...
### [Slack](https://docs.loop69.co.za/sani/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.loop69.co.za/sani/channels/discord)
...
### [Signal](https://docs.loop69.co.za/sani/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.loop69.co.za/sani/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.loop69.co.za/sani/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.loop69.co.za/sani/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.loop69.co.za/sani/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.loop69.co.za/sani)
- [Read the architecture overview for the gateway + protocol model.](https://docs.loop69.co.za/sani/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.loop69.co.za/sani/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.loop69.co.za/sani/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.loop69.co.za/sani/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.loop69.co.za/sani/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.loop69.co.za/sani/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.loop69.co.za/sani/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.loop69.co.za/sani/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.loop69.co.za/sani/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.loop69.co.za/sani/platforms/windows), [Linux](https://docs.loop69.co.za/sani/platforms/linux), [macOS](https://docs.loop69.co.za/sani/platforms/macos), [iOS](https://docs.loop69.co.za/sani/platforms/ios), [Android](https://docs.loop69.co.za/sani/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.loop69.co.za/sani/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.loop69.co.za/sani/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.loop69.co.za/sani/gateway/discovery)
- [Bonjour/mDNS](https://docs.loop69.co.za/sani/gateway/bonjour)
- [Gateway pairing](https://docs.loop69.co.za/sani/gateway/pairing)
- [Remote gateway README](https://docs.loop69.co.za/sani/gateway/remote-gateway-readme)
- [Control UI](https://docs.loop69.co.za/sani/web/control-ui)
- [Dashboard](https://docs.loop69.co.za/sani/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.loop69.co.za/sani/gateway/health)
- [Gateway lock](https://docs.loop69.co.za/sani/gateway/gateway-lock)
- [Background process](https://docs.loop69.co.za/sani/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.loop69.co.za/sani/tools/browser-linux-troubleshooting)
- [Logging](https://docs.loop69.co.za/sani/logging)

## Deep dives

- [Agent loop](https://docs.loop69.co.za/sani/concepts/agent-loop)
- [Presence](https://docs.loop69.co.za/sani/concepts/presence)
- [TypeBox schemas](https://docs.loop69.co.za/sani/concepts/typebox)
- [RPC adapters](https://docs.loop69.co.za/sani/reference/rpc)
- [Queue](https://docs.loop69.co.za/sani/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.loop69.co.za/sani/tools/skills-config)
- [Default AGENTS](https://docs.loop69.co.za/sani/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.loop69.co.za/sani/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.loop69.co.za/sani/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.loop69.co.za/sani/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.loop69.co.za/sani/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.loop69.co.za/sani/reference/templates/TOOLS)
- [Templates: USER](https://docs.loop69.co.za/sani/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.loop69.co.za/sani/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.loop69.co.za/sani/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.loop69.co.za/sani/platforms/mac/voicewake)
- [iOS node](https://docs.loop69.co.za/sani/platforms/ios)
- [Android node](https://docs.loop69.co.za/sani/platforms/android)
- [Windows (WSL2)](https://docs.loop69.co.za/sani/platforms/windows)
- [Linux app](https://docs.loop69.co.za/sani/platforms/linux)

## Email hooks (Gmail)

- [docs.loop69.co.za/sani/gmail-pubsub](https://docs.loop69.co.za/sani/automation/gmail-pubsub)

## Molty

## Credits

Sani is based on SANI, which was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [loop69.co.za/sani](https://loop69.co.za/sani)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@saniai](https://x.com/saniai)
