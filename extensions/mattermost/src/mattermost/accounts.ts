...
export function listMattermostAccountIds(cfg: SANIConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: SANIConfig): string {
...
export function listEnabledMattermostAccounts(cfg: SANIConfig): ResolvedMattermostAccount[] {
