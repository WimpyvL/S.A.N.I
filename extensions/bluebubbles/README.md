...
This directory contains the **BlueBubbles external channel plugin** for SANI.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `sani/plugin-sdk` helpers.
