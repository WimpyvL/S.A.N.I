...
export function listBlueBubblesAccountIds(cfg: SANIConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: SANIConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: SANIConfig): ResolvedBlueBubblesAccount[] {
