...
import type { ReplyPayload, SANIConfig } from "sani/plugin-sdk";
import { createReplyPrefixOptions } from "sani/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as SANIConfig;
