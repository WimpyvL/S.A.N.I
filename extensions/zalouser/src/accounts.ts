...
export function listZalouserAccountIds(cfg: SANIConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: SANIConfig): string {
...
function mergeZalouserAccountConfig(cfg: SANIConfig, accountId: string): ZalouserAccountConfig {
