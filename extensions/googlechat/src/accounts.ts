...
export function listGoogleChatAccountIds(cfg: SANIConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: SANIConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: SANIConfig): ResolvedGoogleChatAccount[] {
