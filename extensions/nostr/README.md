...
Nostr DM channel plugin for SANI using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to SANI. It enables your bot to:
...
# Configure sani to use local relay
