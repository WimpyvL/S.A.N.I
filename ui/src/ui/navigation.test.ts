...
describe("subtitleForTab", () => {
  ...
  it("returns descriptive subtitles", () => {
    ...
    expect(subtitleForTab("config")).toContain("sani.json");
  });
});
...
describe("normalizeBasePath", () => {
  ...
  it("handles nested paths", () => {
    expect(normalizeBasePath("/apps/sani")).toBe("/apps/sani");
  });
});
...
describe("pathForTab", () => {
  ...
  it("prepends base path", () => {
    ...
    expect(pathForTab("sessions", "/apps/sani")).toBe("/apps/sani/sessions");
  });
});
...
describe("tabFromPath", () => {
  ...
  it("handles base paths", () => {
    ...
    expect(tabFromPath("/apps/sani/sessions", "/apps/sani")).toBe("sessions");
  });
...
describe("inferBasePathFromPathname", () => {
  ...
  it("infers base path from nested paths", () => {
    ...
    expect(inferBasePathFromPathname("/apps/sani/sessions")).toBe("/apps/sani");
  });
