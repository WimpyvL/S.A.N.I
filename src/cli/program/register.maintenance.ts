...
export function registerMaintenanceCommands(program: Command) {
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/doctor", "loop69.co.za/sani/cli/doctor")}\n`,
    )
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/dashboard", "loop69.co.za/sani/cli/dashboard")}\n`,
    )
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/reset", "loop69.co.za/sani/cli/reset")}\n`,
    )
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/uninstall", "loop69.co.za/sani/cli/uninstall")}\n`,
    )
