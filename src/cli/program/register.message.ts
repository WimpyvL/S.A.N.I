...
${formatHelpExamples([
          ['sani message send --target +15555550123 --message "Hi"', "Send a text message."],
          [
            'sani message send --target +15555550123 --message "Hi" --media photo.jpg',
          ...
          [
            'sani message react --channel discord --target 123 --message-id 456 --emoji "✅"',
            "React to a message.",
          ],
        ])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "loop69.co.za/sani/cli/message")}`,
    )
    .action(() => {
