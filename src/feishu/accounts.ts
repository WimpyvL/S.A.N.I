...
function mergeFeishuAccountConfig(cfg: SANIConfig, accountId: string): FeishuAccountConfig {
...
export function listFeishuAccountIds(cfg: SANIConfig): string[] {
...
export function resolveDefaultFeishuAccountId(cfg: SANIConfig): string {
