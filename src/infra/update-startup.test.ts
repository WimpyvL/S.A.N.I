...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "sani-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveSANIPackageRoot } = await import("./sani-root.js");
    ...
    vi.mocked(resolveSANIPackageRoot).mockResolvedValue("/opt/sani");
