...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: SANIConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: SANIConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: SANIConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: SANIConfig): void {
