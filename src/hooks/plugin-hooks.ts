...
import type { SANIPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: SANIPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: SANIPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
