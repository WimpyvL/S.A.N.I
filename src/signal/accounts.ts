...
export function listSignalAccountIds(cfg: SANIConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: SANIConfig): string {
...
function mergeSignalAccountConfig(cfg: SANIConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SANIConfig): ResolvedSignalAccount[] {
