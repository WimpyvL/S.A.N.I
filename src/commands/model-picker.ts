...
function resolveConfiguredModelRaw(cfg: SANIConfig): string {
...
function resolveConfiguredModelKeys(cfg: SANIConfig): string[] {
...
export function applyPrimaryModel(cfg: SANIConfig, model: string): SANIConfig {
...
export function applyModelAllowlist(cfg: SANIConfig, models: string[]): SANIConfig {
  const defaults = cfg.agents?.defaults;
