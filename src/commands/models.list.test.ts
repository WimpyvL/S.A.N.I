...
const ensureSANIModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveSANIAgentDir = vi.fn().mockReturnValue("/tmp/sani-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/sani-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureSANIModelsJson,
}));
