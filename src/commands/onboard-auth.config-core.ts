...
export function applyZaiConfig(cfg: SANIConfig): SANIConfig {
...
export function applyOpenrouterProviderConfig(cfg: SANIConfig): SANIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: SANIConfig): SANIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: SANIConfig): SANIConfig {
...
export function applyOpenrouterConfig(cfg: SANIConfig): SANIConfig {
...
export function applyMoonshotProviderConfig(cfg: SANIConfig): SANIConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: SANIConfig): SANIConfig {
...
export function applyMoonshotConfig(cfg: SANIConfig): SANIConfig {
...
export function applyMoonshotConfigCn(cfg: SANIConfig): SANIConfig {
...
export function applyKimiCodeProviderConfig(cfg: SANIConfig): SANIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: SANIConfig): SANIConfig {
...
export function applySyntheticProviderConfig(cfg: SANIConfig): SANIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: SANIConfig): SANIConfig {
...
export function applyXiaomiProviderConfig(cfg: SANIConfig): SANIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: SANIConfig): SANIConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: SANIConfig): SANIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: SANIConfig): SANIConfig {
