...
function resolveDefaultAccountId(cfg: SANIConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SANIConfig): boolean {
...
export function summarizeBindings(cfg: SANIConfig, bindings: AgentBinding[]): string[] {
