...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "sani-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<SANIConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<SANIConfig["telegram"]>>,
