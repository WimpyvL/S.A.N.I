...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SANI_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: SANIConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: SANIConfig): string {
...
function mergeTelegramAccountConfig(cfg: SANIConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: SANIConfig): ResolvedTelegramAccount[] {
