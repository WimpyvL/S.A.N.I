...
export function listSlackAccountIds(cfg: SANIConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: SANIConfig): string {
...
function mergeSlackAccountConfig(cfg: SANIConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: SANIConfig): ResolvedSlackAccount[] {
