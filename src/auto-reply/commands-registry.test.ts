...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@sani", { botUsername: "sani" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@sani args", {
        botUsername: "sani",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "sani" })).toBe(
      "/help@otherbot",
    );
  });
