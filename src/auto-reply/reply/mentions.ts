...
function resolveMentionPatterns(cfg: SANIConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SANIConfig | undefined, agentId?: string): RegExp[] {
