...
export function listBindings(cfg: SANIConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: SANIConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SANIConfig) {
