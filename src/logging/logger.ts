...
export const DEFAULT_LOG_DIR = "/tmp/sani";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "sani.log"); // legacy single-file path

const LOG_PREFIX = "sani";
...
function resolveSettings(): ResolvedSettings {
  let cfg: SANIConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => SANIConfig;
      };
