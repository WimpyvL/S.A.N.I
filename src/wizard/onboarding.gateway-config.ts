...
import type { GatewayBindMode, GatewayTailscaleMode, SANIConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.sani.ai/gateway/tailscale", "https://docs.sani.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
