...
import { type SANIConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: SANIConfig): string[] {
...
export function listAgentsForGateway(cfg: SANIConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: SANIConfig): string {
...
function resolveSessionStoreAgentId(cfg: SANIConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: SANIConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: SANIConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: SANIConfig): GatewaySessionsDefaults {
