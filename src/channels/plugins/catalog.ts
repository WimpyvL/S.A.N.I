...
import type { SANIPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverSANIPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, SANIPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["SANI_PLUGIN_CATALOG_PATHS", "SANI_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<SANIPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: SANIPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverSANIPlugins({ workspaceDir: options.workspaceDir });
