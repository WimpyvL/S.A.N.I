...
export type ChannelAgentToolFactory = (params: { cfg?: SANIConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: SANIConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: SANIConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: SANIConfig }) => boolean;
  supportsCards?: (params: { cfg: SANIConfig }) => boolean;
