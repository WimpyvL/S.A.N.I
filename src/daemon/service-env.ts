...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.SANI_STATE_DIR;
  const configPath = env.SANI_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    SANI_PROFILE: profile,
    SANI_STATE_DIR: stateDir,
    SANI_CONFIG_PATH: configPath,
    SANI_GATEWAY_PORT: String(port),
    SANI_GATEWAY_TOKEN: token,
    SANI_LAUNCHD_LABEL: resolvedLaunchdLabel,
    SANI_SYSTEMD_UNIT: systemdUnit,
    SANI_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    SANI_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    SANI_STATE_DIR: stateDir,
    SANI_CONFIG_PATH: configPath,
    SANI_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    SANI_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    SANI_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    SANI_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    SANI_LOG_PREFIX: "node",
    SANI_SERVICE_MARKER: NODE_SERVICE_MARKER,
    SANI_SERVICE_KIND: NODE_SERVICE_KIND,
    SANI_SERVICE_VERSION: VERSION,
  };
}
