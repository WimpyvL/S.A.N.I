...
describe("resolveGatewayProgramArguments", () => {
  it("uses realpath-resolved dist entry when running via npx shim", async () => {
    const argv1 = path.resolve("/tmp/.npm/_npx/63c3/node_modules/.bin/sani");
    const entryPath = path.resolve("/tmp/.npm/_npx/63c3/node_modules/sani/dist/entry.js");
  ...
  it("prefers symlinked path over realpath for stable service config", async () => {
    // Simulates pnpm global install where node_modules/sani is a symlink
    // to .pnpm/sani@X.Y.Z/node_modules/sani
    const symlinkPath = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/sani/dist/entry.js",
    );
    const realpathResolved = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/.pnpm/sani@2026.1.21-2/node_modules/sani/dist/entry.js",
    );
  ...
  it("falls back to node_modules package dist when .bin path is not resolved", async () => {
    const argv1 = path.resolve("/tmp/.npm/_npx/63c3/node_modules/.bin/sani");
    const indexPath = path.resolve("/tmp/.npm/_npx/63c3/node_modules/sani/dist/index.js");
    process.argv = ["node", argv1];
