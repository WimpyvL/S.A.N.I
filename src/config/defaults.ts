...
function resolveAnthropicDefaultAuthMode(cfg: SANIConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SANIConfig): SANIConfig {
...
export function applyTalkApiKey(config: SANIConfig): SANIConfig {
...
export function applyModelDefaults(cfg: SANIConfig): SANIConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SANIConfig): SANIConfig {
...
export function applyLoggingDefaults(cfg: SANIConfig): SANIConfig {
...
export function applyContextPruningDefaults(cfg: SANIConfig): SANIConfig {
...
export function applyCompactionDefaults(cfg: SANIConfig): SANIConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
