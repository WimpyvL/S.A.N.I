...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @sani/voice-call -> voice-call).
...
export function discoverSANIPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".sani", "extensions")];
