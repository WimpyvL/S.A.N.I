...
export function createSandboxedReadTool(root: string) {
  ...
  return wrapSandboxPathGuard(createSaniReadTool(base), root);
}
...
export function createSaniReadTool(base: AnyAgentTool): AnyAgentTool {
...
/** @deprecated Use createSaniReadTool */
export const createSANIReadTool = createSaniReadTool;
