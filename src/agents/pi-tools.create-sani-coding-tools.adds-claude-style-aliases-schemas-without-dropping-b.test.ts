...
describe("createSANICodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createSANICodingTools({
      config,
    ...
    const anthropicTools = createSANICodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createSANICodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createSANICodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
