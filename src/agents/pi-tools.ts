...
function resolveExecConfig(cfg: SaniConfig | undefined) {
...
export function createSaniCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createSaniReadTool(freshReadTool)];
    }
...
/** @deprecated Use createSaniCodingTools */
export const createSANICodingTools = createSaniCodingTools;
