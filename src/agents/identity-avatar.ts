...
function resolveAvatarSource(cfg: SaniConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SaniConfig, agentId: string): AgentAvatarResolution {
