...
function resolveWatchPaths(workspaceDir: string, config?: SANIConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: SANIConfig }) {
