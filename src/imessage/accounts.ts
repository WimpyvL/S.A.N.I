...
export function listIMessageAccountIds(cfg: SANIConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: SANIConfig): string {
...
function mergeIMessageAccountConfig(cfg: SANIConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: SANIConfig): ResolvedIMessageAccount[] {
