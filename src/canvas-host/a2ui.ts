...
export const A2UI_PATH = "/__sani__/a2ui";

export const CANVAS_HOST_PATH = "/__sani__/canvas";

export const CANVAS_WS_PATH = "/__sani__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.saniCanvasA2UIAction.postMessage(...)
  // - Android: window.saniCanvasA2UIAction.postMessage(...)
  const handlerNames = ["saniCanvasA2UIAction"];
  ...
  globalThis.SANI = globalThis.SANI ?? {};
  globalThis.SANI.postMessage = postToNode;
  globalThis.SANI.sendUserAction = sendUserAction;
  globalThis.saniPostMessage = postToNode;
  globalThis.saniSendUserAction = sendUserAction;
