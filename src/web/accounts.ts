...
function listConfiguredAccountIds(cfg: SANIConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: SANIConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SANIConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: SANIConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: SANIConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: SANIConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SANIConfig): ResolvedWhatsAppAccount[] {
