          ...
          [
            {
              ...
              "extract": true,
              "stripComponents": 1,
              "targetDir": "~/.sani/tools/sherpa-onnx-tts/runtime",
            ...
            },
            {
              ...
              "archive": "tar.bz2",
              "extract": true,
              "targetDir": "~/.sani/tools/sherpa-onnx-tts/models",
...
1. Download the runtime for your OS (extracts into `~/.sani/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.sani/tools/sherpa-onnx-tts/models`)

Update `~/.sani/sani.json`:
...
```json5
{
  skills: {
    entries: {
      "sherpa-onnx-tts": {
        env: {
          SHERPA_ONNX_RUNTIME_DIR: "~/.sani/tools/sherpa-onnx-tts/runtime",
          SHERPA_ONNX_MODEL_DIR: "~/.sani/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high",
        },
      },
    },
  },
