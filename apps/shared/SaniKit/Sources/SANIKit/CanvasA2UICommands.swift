...
public enum SANICanvasA2UICommand: String, Codable, Sendable {
...
public struct SANICanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SANICanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
