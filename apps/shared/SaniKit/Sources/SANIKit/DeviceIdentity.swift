...
enum DeviceIdentityPaths {
    private static let stateDirEnv = ["SANI_STATE_DIR"]
    ...
    static func stateDirURL() -> URL {
        ...
        if let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            return appSupport.appendingPathComponent("SANI", isDirectory: true)
        }

        return FileManager.default.temporaryDirectory.appendingPathComponent("sani", isDirectory: true)
    }
}
