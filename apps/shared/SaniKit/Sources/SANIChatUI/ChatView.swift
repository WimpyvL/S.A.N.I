...
@MainActor
public struct SANIChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    private var visibleMessages: [SANIChatMessage] {
        let base: [SANIChatMessage]
    ...
    private func mergeToolResults(in messages: [SANIChatMessage]) -> [SANIChatMessage] {
    ...
    private func isToolResultMessage(_ message: SANIChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SANIChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SANIChatMessage) -> String {
