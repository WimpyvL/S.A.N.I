...
public typealias SANIPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SANIPlatformImage = UIImage
#endif

public struct SANIChatUsageCost: Codable, Hashable, Sendable {
...
public struct SANIChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SANIChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SANIChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SANIChatMessageContent: Codable, Hashable, Sendable {
...
public struct SANIChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SANIChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SANIChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SANIChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SANIChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SANIChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SANIChatMessageContent].self, forKey: .content) {
...
public struct SANIChatHistoryPayload: Codable, Sendable {
...
public struct SANISessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SANISessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SANISessionPreviewItem]
}

public struct SANISessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SANISessionPreviewEntry]

    public init(ts: Int, previews: [SANISessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SANIChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SANIChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SANIAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SANIChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SANIGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SANIPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SANIPlatformImage?
...
public struct SANIChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
