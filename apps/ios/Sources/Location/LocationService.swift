...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: SANILocationMode) async -> CLAuthorizationStatus {
    ...
    private static func accuracyValue(_ accuracy: SANILocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
