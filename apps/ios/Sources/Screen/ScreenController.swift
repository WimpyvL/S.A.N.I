...
final class ScreenController {
    ...
    /// Callback invoked when an sani:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = SANIKitResources.bundle
...
/// Handles navigation policy to intercept sani:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept sani:// deep links.
        if url.scheme?.lowercased() == "sani" {
