## SANI Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_sani-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm sani gateway --port 18789 --verbose
```
