...
extension OnboardingView {
    ...
    func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .saniSelectSettingsTab, object: tab)
        }
    }
    ...
    func finish() {
        UserDefaults.standard.set(true, forKey: "sani.onboardingSeen")
    ...
    func finishAnthropicOAuth() async {
        ...
        do {
            ...
            self.anthropicAuthStatus = "Connected. SANI can now use Claude."
        } catch {
