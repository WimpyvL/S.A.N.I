...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SANIConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SANIConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SANIConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/sani"
        state.remoteCliPath = ""
        return state
    }
}
