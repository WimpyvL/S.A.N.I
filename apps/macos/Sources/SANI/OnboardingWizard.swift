...
private let onboardingWizardLogger = Logger(subsystem: "ai.sani", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between SANIProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = SANIProtocol.AnyCodable
