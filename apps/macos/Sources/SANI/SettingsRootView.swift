...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .saniSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SANIPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SANIPaths.stateDirURL.path
...
extension Notification.Name {
    static let saniSelectSettingsTab = Notification.Name("saniSelectSettingsTab")
}
