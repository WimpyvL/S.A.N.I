...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.sani", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SANI windows, but below the system’s pop-up menus.
