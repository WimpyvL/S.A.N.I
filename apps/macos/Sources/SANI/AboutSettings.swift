...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/sani/sani") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/sani/sani")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://sani.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "SANIBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "SANIBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SANIGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SANIGitCommit") as? String) ??
            "unknown"
    }
