...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.sani", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".sani/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.saniCommand(
            subcommand: "gateway",
