...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.sani", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SANI/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__sani__/a2ui/").absoluteString + "?platform=macos"
    }
