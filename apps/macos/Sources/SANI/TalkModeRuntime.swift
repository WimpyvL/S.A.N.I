...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.sani", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.sani", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SANIChatMessage] = messages.compactMap { item in
