...
enum UIStrings {
    static let welcomeTitle = "Welcome to SANI"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: SANIOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: SANIChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g sani@\(version)"
    }
