...
enum DebugActions {
    private static let verboseDefaultsKey = "sani.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "sani.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "SANI", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = SANIPaths.configURL
        guard
