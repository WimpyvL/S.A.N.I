...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.sani", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SANIConfigFile.defaultWorkspaceURL() }
