...
SANI treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.sani/settings/voicewake.json`

Shape:

```json
{ "triggers": ["sani", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
