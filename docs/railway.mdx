...
Deploy SANI on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/sani` — Control UI
...
- `SANI_STATE_DIR=/data/.sani` (recommended)
- `SANI_WORKSPACE_DIR=/data/workspace` (recommended)
- `SANI_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your SANI state + workspace so you can migrate to another host without losing config or memory.
