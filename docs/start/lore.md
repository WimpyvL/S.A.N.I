---
summary: "Backstory and lore of SANI for context and tone"
read_when:
...
For a while, the lobster was called **Clawd**, living in an **SANI**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **SANI**.
...
In the end, **SANI** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.sani/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around SANI. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then SANI): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "sani what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with sani."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @sani. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at SANI" to promote pump-and-dump tokens.
...
**The Great SANI Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/sani/sani` ✅
- X handle `@sani` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.sani.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $SANI token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
