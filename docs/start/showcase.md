---
title: "Showcase"
description: "Real-world SANI projects from the community"
summary: "Community-built projects and integrations powered by SANI"
---

# Showcase

Real projects from the community. See what people are building with SANI.

<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/clawd) or [tag @sani on X](https://x.com/sani).
</Info>
...
>
  <iframe
    ...
    title="SANI: The self-hosted AI that Siri should have been (Full setup)"
...
OpenCode finishes the change → opens a PR → SANI reviews the diff and replies in Telegram with “minor suggestions” plus a clear merge verdict (including critical fixes to apply first).

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="SANI PR review feedback delivered in Telegram" />
</Card>

<Card title="Wine Cellar Skill in Minutes" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

Asked “Robby” (@sani) for a local wine cellar skill. It requests a sample CSV export + where to store it, then builds/tests the skill fast (962 bottles in the example).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="SANI building a local wine cellar skill from CSV" />
</Card>
...
Desktop app to manage skills/commands across Agents, Claude, Codex, and SANI.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Perfect for remote SANI instances.
</Card>
...
CLI for Linear that integrates with agentic workflows (Claude Code, SANI). Manage issues, projects, and workflows from the terminal. First external PR merged!
</Card>
...
Claude Code discovered and confirmed the purifier controls, then SANI takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via SANI" />
</Card>

<Card title="Pretty Sky Camera Shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill` `images`

Triggered by a roof camera: ask SANI to snap a sky photo whenever it looks pretty — it designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by SANI" />
</Card>

<Card title="Visual Morning Briefing Scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `images` `telegram`

A scheduled prompt generates a single "scene" image each morning (weather, tasks, date, favorite post/quote) via a SANI persona.
</Card>
...
SANI connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist Skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `automation` `todoist` `skill` `telegram`

Automated Todoist tasks and had SANI generate the skill directly in Telegram chat.
</Card>
...
<Card title="xuezh Chinese Learning" icon="language" href="https://github.com/joshp123/xuezh">
  **@joshp123** • `learning` `voice` `skill`
  ...
  Chinese learning engine with pronunciation feedback and study flows via SANI.
...
<Card title="Clawdia Phone Bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`
  ...
  Vapi voice assistant ↔ SANI HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/sani-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`
  
  SANI gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/sani/nix-sani">
  **@sani** • `nix` `packaging` `deployment`
  
  Batteries-included nixified SANI configuration for reproducible deployments.
</Card>
...
<Card title="GoHome Automation" icon="house-signal" href="https://github.com/joshp123/gohome">
  **@joshp123** • `home` `nix` `grafana`
  ...
  Nix-native home automation with SANI as the interface, plus beautiful Grafana dashboards.
...
<Card title="StarSwap Marketplace" icon="star" href="https://star-swap.com/">
  **Community** • `marketplace` `astronomy` `webapp`
  ...
  Full astronomy gear marketplace. Built with/around the SANI ecosystem.
</Card>
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/clawd) or [tweet @sani](https://x.com/sani)
  </Step>
