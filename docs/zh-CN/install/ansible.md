...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、加固的 SANI 安装
title: Ansible
x-i18n:
...
将 SANI 部署到生产服务器的推荐方式是通过 **[sani-ansible](https://github.com/sani/sani-ansible)** — 一个安全优先架构的自动化安装程序。
...
> **📦 完整指南：[github.com/sani/sani-ansible](https://github.com/sani/sani-ansible)**
>
> sani-ansible 仓库是 Ansible 部署的权威来源。本页是快速概述。
...
# 或直接运行（然后手动执行 /tmp/sani-setup.sh）
# ansible-playbook playbook.yml --ask-become-pass
```

## 更新 SANI

Ansible 安装程序设置 SANI 为手动更新。标准更新流程参见[更新](/install/updating)。
...
- [安全架构](https://github.com/sani/sani-ansible/blob/main/docs/security.md)
- [技术详情](https://github.com/sani/sani-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/sani/sani-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [sani-ansible](https://github.com/sani/sani-ansible) — 完整部署指南
