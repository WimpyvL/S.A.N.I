...
- Install via CLI: `sani plugins install @sani/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `sani plugins install ./extensions/zalo`
   - From npm (if published): `sani plugins install @sani/zalo`
...
- Approve via:
  - `sani pairing list zalo`
  - `sani pairing approve zalo <CODE>`
...
- Example: `sani message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `sani channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `sani logs --follow`
