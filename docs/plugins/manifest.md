...
read_when:
  - You are building a SANI plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (sani.plugin.json)

Every plugin **must** ship a `sani.plugin.json` file in the **plugin root**.
SANI uses this manifest to validate configuration **without executing plugin
