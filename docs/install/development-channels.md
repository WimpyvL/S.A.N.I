...
SANI ships three update channels:
...
When you **explicitly** switch channels with `--channel`, SANI also aligns
the install method:
...
When you switch channels with `sani update`, SANI also syncs plugin sources:
