...
This page ties together how SANI handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. SANI keeps a
...
SANI separates the **prompt body** from the **command body**:
...
SANI can expose or hide model reasoning:
