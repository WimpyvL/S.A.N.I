...
SANI treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

SANI “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, SANI can see that group and respond there.
...
Translation: allowlisted senders can trigger SANI by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@sani", "sani", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
