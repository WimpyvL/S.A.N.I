...
SANI has two separate “streaming” layers:
...
When block streaming is enabled, SANI can **merge consecutive block chunks**
...
When draft streaming is active, SANI disables block streaming for that reply to avoid double-streaming.
