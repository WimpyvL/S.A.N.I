...
You can point SANI at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or SANI
...
- [Anthropic provider](/providers/anthropic) - Native SANI integration with Claude setup-token or API keys
