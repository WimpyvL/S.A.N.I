---
summary: "Use Synthetic's Anthropic-compatible API in SANI"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. SANI registers it as the
...
Note: SANI's Anthropic client appends `/v1` to the base URL, so use
