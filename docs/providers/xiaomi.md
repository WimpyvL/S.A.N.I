---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with SANI"
read_when:
  - You want Xiaomi MiMo models in SANI
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). SANI uses
