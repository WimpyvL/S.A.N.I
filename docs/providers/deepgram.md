...
Deepgram is a speech-to-text API. In SANI it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, SANI uploads the audio file to Deepgram and injects the transcript
